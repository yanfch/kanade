...
export const GEN_AI_USAGE_COST_INPUT_USD = "gen_ai.usage.cost_input_usd";
export const GEN_AI_USAGE_COST_OUTPUT_USD = "gen_ai.usage.cost_output_usd";
export const GEN_AI_USAGE_COST_CACHE_READ_USD = "gen_ai.usage.cost_cache_read_usd";
